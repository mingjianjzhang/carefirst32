...
const vendorLogos = ["Unismile", "CareFirst Lab", "Precision Implants", "OralTech 3D"];
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-600">
              Earn rewards for your health, and equity for your practice. Powered by secure
              technology.
            </p>
          </div>
          <div className="relative">
            ...
            <div className="relative mx-auto flex h-64 w-64 items-center justify-center">
              <img
                ...
                className="h-48 w-48 rounded-[28px] object-cover shadow-[0_22px_40px_rgba(15,23,42,0.35)]"
              />
            </div>
          </div>
        </div>
        ...
        {isPatients ? (
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-600">
                  $FIRST is your CareFirst rewards balance, ready to offset future care.
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Your Rewards account updates automatically after each visit.
                  </p>
                </div>
          ...
          <div className="mt-8 space-y-8">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">
                $FIRST helps practices capture value from the CareFirst supply network.
              </p>
            </div>
